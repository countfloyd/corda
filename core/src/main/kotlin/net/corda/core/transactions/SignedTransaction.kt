 ...
 */
// DOCSTART 1
data class SignedTransaction(private val transaction: AbstractWireTransaction,
    ...
    fun resolveNotaryChangeTransaction(services: ServiceHub): NotaryChangeTransaction {
